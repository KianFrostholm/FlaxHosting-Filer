        ...
        if registration ~= nil then
          vRP.generatePhoneNumber(function(phone)
            if phone ~= nil then
              ...
              MySQL.Async.execute("INSERT IGNORE INTO vrp_user_identities(user_id,registration,phone,firstname,name,age) VALUES(@user_id,@registration,@phone,@firstname,@name,@age)", {
                user_id = user_id,
