...
Citizen.CreateThread(function()
  TriggerEvent('chat:addSuggestion', '/e', 'Emote', {{ name="emotenavn", help="dance, camera, sit osv."}})
  TriggerEvent('chat:addSuggestion', '/emotemenu', 'Open emotes menu eller klik (F3).')
  TriggerEvent('chat:addSuggestion', '/emotes', 'Liste over alle emotes.')
  TriggerEvent('chat:addSuggestion', '/gågang', 'Vælg en gågang.', {{ name="style", help="/gågang for en liste over alle gågange"}})
  TriggerEvent('chat:addSuggestion', '/gågange', 'Liste over alle gågange.')
end)
...
RegisterCommand('gågang', function(source, args, raw) WalkCommandStart(source, args, raw) end)
RegisterCommand('gågange', function(source, args, raw) WalksOnCommand() end)
...
function EmoteChatMessage(args)
  if args == display then
    TriggerEvent("chatMessage", "^1Hjælp^0", {0,0,0}, string.format(""))
  else
    TriggerEvent("chatMessage", "^1Hjælp^0", {0,0,0}, string.format(""..args..""))
  end
end
