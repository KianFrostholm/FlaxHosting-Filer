Crypto = {
    ...
    Permission = 'player.spawnvehicle',
}
...
Ticker = {
    ...
    Api_key = '232831b0961bef12195101d67b1f430d519c82dd0ea280cbe4d7776f84c2ea46', -- If you decide to get an api key for the API (https://min-api.cryptocompare.com/pricing) The free plan should be more than enough for 1 Fivem server
