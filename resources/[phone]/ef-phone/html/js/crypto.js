        ...
        if (QB.Phone.Data.PlayerData.money.bank >= Price) {
            $.post('https://ef-phone/BuyCrypto', JSON.stringify({
                ...
                if (CryptoData !== false) {
                    ...
                    QB.Phone.Notifications.Add("fas fa-university", "QBank", ""+Price+" DKK er blevet trukket fra din balance!", "#badc58", 2500);
                } else {
        ...
        if (CryptoData.Portfolio >= parseInt(Coins)) {
            $.post('https://ef-phone/SellCrypto', JSON.stringify({
                ...
                if (CryptoData !== false) {
                    ...
                    CloseCryptoPage()
                    QB.Phone.Data.PlayerData.money.bank = parseInt(QB.Phone.Data.PlayerData.money.bank) + parseInt(Price);
                    QB.Phone.Notifications.Add("fas fa-university", "QBank", ""+Price+" DKK er blevet tilføjet til din balance!", "#badc58", 2500);
                } else {
                    QB.Phone.Notifications.Add("fas fa-chart-pie", "Krypto", "Du har ikke nok Qbits..", "#badc58", 1500);
                }
            });
        } else {
            QB.Phone.Notifications.Add("fas fa-chart-pie", "Krypto", "Du har ikke nok Qbits..", "#badc58", 1500);
            ...
            if (WalletId !== CryptoData.WalletId) {
                $.post('https://ef-phone/TransferCrypto', JSON.stringify({
                    ...
                    if (CryptoData == "notenough") {
                        ...
                        QB.Phone.Notifications.Add("fas fa-university", "Krypto", "Denne Wallet-ID findes ikke!", "#badc58", 2500);
                    } else {
                        UpdateCryptoData(CryptoData)
                        CloseCryptoPage()
                        QB.Phone.Notifications.Add("fas fa-university", "Krypto", "Du har overført "+Coins+",- til "+WalletId+"!", "#badc58", 2500);
                    }
                });
            } else {
