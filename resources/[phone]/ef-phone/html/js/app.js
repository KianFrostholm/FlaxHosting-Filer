...
$.each(data.applications, function(i, app){
    ...
    if ((!app.job || app.job === QB.Phone.Data.PlayerJob.name) && !blockedapp) {
        ...
        if (app.app == "whatsapp") {
            icon = '<img src="./img/apps/Messages.png" class="ef-app-icon">';
        }
        if (app.app == "phone") {
            icon = '<img src="./img/apps/Phone.png" class="ef-app-icon">';
        }
        if (app.app == "settings") {
            icon = '<img src="./img/apps/Settings.png" class="ef-app-icon">';
        }
        if (app.app == "twitter") {
            icon = '<img src="./img/apps/Birdy.png" class="ef-app-icon">';
        }
        if (app.app == "mail") {
            icon = '<img src="./img/apps/Mail.png" class="ef-app-icon">';
        }
        if (app.app == "camera") {
            icon = '<img src="./img/apps/Camera.png" class="ef-app-icon">';
        }
        if (app.app == "gallery") {
            icon = '<img src="./img/apps/Photos.png" class="ef-app-icon">';
        }
        ...
        if (app.app == "advert") {
            icon = '<img src="./img/apps/YellowPages.png" class="ef-app-icon">';
        }
        if (app.app == "bank") {
            icon = '<img src="./img/apps/Wallet.png" class="ef-app-icon">';
        }
        if (app.app == "garage") {
            icon = '<img src="./img/apps/Garage.png" class="ef-app-icon">';
        }
        if (app.app == "bill"){
        icon = '<img src="./img/apps/invoices.png" class="ef-app-icon">';
        }
        if (app.app == "lawyers") {
            icon = '<img src="./img/apps/Services.png" class="ef-app-icon">';
        }
        if (app.app == "racing") {
            icon = '<img src="./img/apps/racing.png" class="ef-app-icon">';
        }
        if (app.app == "crypto") {
            icon = '<img src="./img/apps/Crypto.png" class="ef-app-icon">';
        }
        if (app.app == "ping") {
...
//    if (event.key === "Alt") {
//        $.post('https://ef-phone/closeNUI', JSON.stringify({}));
//    }
//};
...
$(document).on('click', '#ShareContact', function(e){
    $.post('https://ef-phone/ShareContact', JSON.stringify({}));
});
    ...
    window.addEventListener('message', function(event) {
        switch(event.data.action) {
            ...
            case "UpdateRacingApp":
                ...
                break;
            case "ShareContact":
                $.post('https://ef-phone/ShareContact', JSON.stringify({}), function(Races){
                    SetupRaces(Races);
                });
                break;
            case "RefreshAlerts":
