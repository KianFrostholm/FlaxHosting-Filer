...
$(document).on('click', '#join-race', function(e){
    ...
    $.post('https://ef-phone/IsInRace', JSON.stringify({}), function(IsInRace){
        if (!IsInRace) {
            ...
            QB.Phone.Notifications.Add("fas fa-flag-checkered", "Racing", "Du er allerede i et løb..", "#1DA1F2");
        }
    });
});
            ...
            if (!data.IsBusy) {
                $.post('https://ef-phone/IsBusyCheck', JSON.stringify({
                    ...
                    if (!InRace) {
                        ...
                        QB.Phone.Notifications.Add("fas fa-flag-checkered", "Racing", "Du er i et løb..", "#1DA1F2");
                    }
                });
            } else {
                QB.Phone.Notifications.Add("fas fa-flag-checkered", "Racing", "Du er allerede i gang med at opsætte en bane..", "#1DA1F2");
            }
        } else {
            QB.Phone.Notifications.Add("fas fa-flag-checkered", "Racing", "Du har ikke rettigheder til at oprette Race Tracks..", "#1DA1F2");
        }
    });
});
...
$(document).on('click', '#racing-create-accept', function(e){
    ...
    if (TrackName !== "" && TrackName !== undefined && TrackName !== null) {
        ...
        if (TrackName == '') TrackName = 'Hvad prøver du at gøre?'
        ...
        QB.Phone.Notifications.Add("fas fa-flag-checkered", "Racing", "Du skal indtaste et banenavn..", "#1DA1F2");
    }
});
...
$(document).on('click', '#setup-race-accept', function(e){
    ...
    $.post('https://ef-phone/HasCreatedRace', JSON.stringify({}), function(HasCreatedRace){
        if (!HasCreatedRace) {
                        ...
                        if (laps !== "") {
                            $.post('https://ef-phone/CanRaceSetup', JSON.stringify({}), function(CanSetup){
                                if (CanSetup) {
                                    ...
                                    QB.Phone.Notifications.Add("fas fa-flag-checkered", "Racing", "Der kan ikke være nogen ..", "#1DA1F2");
                                }
                            });
                        } else {
                            QB.Phone.Notifications.Add("fas fa-flag-checkered", "Racing", "Udfyld antallet af omgange..", "#1DA1F2");
                        }
                    } else {
            ...
            QB.Phone.Notifications.Add("fas fa-flag-checkered", "Racing", "Du har allerede et aktivt løb..", "#1DA1F2");
        }
    });
});
