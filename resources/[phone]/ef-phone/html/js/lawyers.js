SetupLawyers = function(data) {
    ...
    if (data.length > 0) {
        ...
        $.each(data, function(i, lawyer) {
            if (lawyer.typejob == "Advokat") {
                lawyers.push(lawyer);
            }
            if (lawyer.typejob == "Ejendomsmægler") {
                realestate.push(lawyer);
            }
            if (lawyer.typejob == "Mekaniker") {
                mechanic.push(lawyer);
            }
            if (lawyer.typejob == "Taxi") {
                taxi.push(lawyer);
            }
            if (lawyer.typejob == "Politi-Job") {
                police.push(lawyer);
            }
        ...
        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(255, 190, 27);">Taxaer ' + taxi.length + '</h1>');
        ...
        if (police.length > 0) {
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">Der er ingen politi til rådighed.</div></div>'
            $(".lawyers-list").append(element);
        }
        ...
        if (ambulance.length > 0) {
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">Der er ingen ambulancefolk til rådighed..</div></div>'
            $(".lawyers-list").append(element);
        }
    } else {
        $(".lawyers-list").append('<h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; border-top-left-radius: .5vh; border-top-right-radius: .5vh; width:100%; display:block; background-color: rgb(42, 137, 214);">Advokater (' + lawyers.length + ')</h1>');
                ...
                if (status.CanCall) {
                    if (!status.InCall) {
                        if (QB.Phone.Data.AnonymousCall) {
                            QB.Phone.Notifications.Add("fas fa-phone", "Telefon", "Du har startet et anonymt opkald!");
                        }
